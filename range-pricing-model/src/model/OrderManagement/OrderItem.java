...
public class OrderItem {
    ...
    //calculates what the price gain would have been if products were sold at target price
    ...
    public int calculateActualPriceSum() {
        return actualPrice * quantity;
    }
    ...
    public void printOrderItemInfo(){
        System.out.println("Product: " + selectedproduct.getName() + " FloorPrice: " + selectedproduct.getFloorPrice() + 
        " CeilingPrice: " + selectedproduct.getCeilingPrice() + " TargetPrice: " + selectedproduct.getTargetPrice() + 
        " ActualPrice: " + getActualPrice() + " Quantity: " + getQuantity());       
    }
